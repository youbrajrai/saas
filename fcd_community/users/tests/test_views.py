...
from fcd_community.users.views import UserRedirectView
from fcd_community.users.views import UserUpdateView
from fcd_community.users.views import user_detail_view
